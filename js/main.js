...
function addsdata() {
    ...
    if (name1 == '' || stream1 == '' || marks1 == '')
    ...
    } else if (!p4.test(stream1)||!p3.test(stream1)) {
        ...
        let list11 = "<tr class=" + student[a].rollno + "><td><input id=" + student[adddata].rollno + " type=\"checkbox\"></td><td class=" + student[a].rollno + ">" + student[a].rollno + "</td>";
